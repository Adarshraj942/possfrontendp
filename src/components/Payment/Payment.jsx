...
import kiu from '../../assets/kiu.png'
    ...
    <div className='flexcontent4' style={{marginTop:'40px'}}>
        <div className='flexleft0' >
            ...
            <div className='paymentgatway'>
                ...
                <div align='center'  id='paycontainer'>
                <div className='card' id='paycards'><h3> <img src={tick} alt="" /> <span style={{marginLeft:'20px'}}>UPI</span> </h3></div>
            <div className='card'  id='paycards' style={{marginTop:'20px'}}><h3><img src={tick} alt="" /><span style={{marginLeft:'20px'}}>COD</span></h3></div>
            <div className='card' id='paycards' style={{marginTop:'20px'}}><h3> <img src={tick} alt="" /><span style={{marginLeft:'20px'}}>Net Banking</span></h3></div>
                </div>

            </div>
                
    <div className='cssbtn'  ><button className='paybtn'> <span style={{marginRight:'10px'}}><img src={back} alt="" /></span> Pay with Upi</button></div>
        </div>
